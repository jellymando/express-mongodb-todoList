...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"components/CreateInput.js":[function(require,module,exports) {
"use strict";
...
var CreateInput = /*#__PURE__*/function () {
  function CreateInput($root) {
    ...
    this.find = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var response;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _axios.default.get('/find');
...
},{"axios":"node_modules/axios/index.js"}],"components/ItemList.js":[function(require,module,exports) {
"use strict";
...
var ItemList = /*#__PURE__*/function () {
  function ItemList($root, items) {
    _classCallCheck(this, ItemList);

    this.items = items;
    var $itemListWrap = document.createElement("div");
  ...
  _createClass(ItemList, [{
    ...
    value: function render() {
      if (this.items.length > 0) {
        this.$itemListWrap.innerHTML = this.items.map(function (item) {
          return "\n                <div class=\"item\">\n                    ".concat(item.title, "\n                </div>\n                ");
        }).join("");
      } else {
...
var _CreateInput = _interopRequireDefault(require("/components/CreateInput.js"));

var _ItemList = _interopRequireDefault(require("/components/ItemList.js"));
...
var App = function App($root) {
  ...
  this.$root = $root;
  this.items = [];
  this.createInput = new _CreateInput.default($root);
  this.itemList = new _ItemList.default($root, this.items);
};

exports.default = App;
},{"/components/CreateInput.js":"components/CreateInput.js","/components/ItemList.js":"components/ItemList.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
new _App.default(document.querySelector('#root'));
...
//# sourceMappingURL=/express-mongodb.e31bb0bc.js.map